...
for original in pathlib.Path('/home/user/InstantID/Originals').iterdir():
    orignal_filename = original.split('/')[-1].split('.')[0]
    face_image = load_image(original)
    ...
    for prompt in prompts:
        ...
        prompt += ' cinematic still a photo of a man . emotional, harmonious, vignette, 4k epic detailed, shot on kodak, 35mm photo, sharp focus, high budget, cinemascope, moody, epic, gorgeous, film grain, grainy'
